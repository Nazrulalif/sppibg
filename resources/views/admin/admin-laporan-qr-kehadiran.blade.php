                ...
                <div class="card p-5">
                    <div class="header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-auto text-center text-sm-right">
                                <h4><strong>Laporan Kehadiran Mesyuarat</strong></h4>
                    ...
                    <div class="row" >
                        <div class="col-12 p-4" style="align-items: center; display: flex; justify-content: center; flex-direction: column;">
                            <h4 class="title">{{$data->nama_mesyuarat}}</h4>
                            <p>{{ \Carbon\Carbon::parse($data->tarikh)->format('l, j F Y') }}, {{ \Carbon\Carbon::parse($data->masa_mula)->format('h:i A') }} - {{ \Carbon\Carbon::parse($data->masa_tamat)->format('h:i A') }}</p>
                            <p></p>
                        </div>
                    </div>
