                ...
                <div class="card p-5">
                    ...
                    <div class="row">
                        <div class="col-12 p-4"
                            ...
                            <h4 class="title">{{$sumbangan->nama_sumbangan}}</h4>
                            <p></p>
                        </div>
                    </div>
                    <div class="card-body p-3 pt-1 mb-3">
                        <table class="table table-bordered bg-light">
                            <tr>
                                <th style="width: 30%">Jumlah Kutipan Sumbangan</th>
                                <td>RM {{$jumlah_kutipan}}</td>

                                <th style="width: 30%">Jumlah Sasaran</th>
                                <td>RM {{$jumlah_sasaran->jumlah_sasaran}}</td>
                            </tr>
                            <tr>
                                <th style="width: 30%">Jumlah Penyumbang</th>
                                <td>{{$jumlah_penyumbang}}</td>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>ID Transaksi</th>
                                    <th style="width: 30%">Nama Ahli</th>
                                    <th>Jenis Pembayaran</th>
                                    <th>Jumlah Sumbagan</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>RM {{$item->jumlah_sumbangan}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
