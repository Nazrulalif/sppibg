        ...
        <section class="content p-sm-5">
            ...
            <div class="container-fluid" id="printable-content">
                ...
                <div class="card p-5">
                    <div class="header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-auto text-center text-sm-right">
                                <h4><strong>Laporan Usul Mesyuarat</strong></h4>
                    ...
                    <hr>
                    <div class="row" >
                        <div class="col-12 p-4" style="align-items: center; display: flex; justify-content: center;">
                            <h4 class="title">{{$mesyuarat->nama_mesyuarat}}</h4>
                        </div>
                    </div>
