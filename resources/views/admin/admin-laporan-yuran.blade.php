                ...
                <div class="card p-5">
                    <div class="header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-auto text-center text-sm-right">
                                <h4><strong>Laporan Bayaran Yuran</strong></h4>
                    ...
                    <div class="row">
                        <div class="col-12 p-4"
                            ...
                            <h4 class="title">Senarai Bayaran Yuran Tahun {{$tahun}}</h4>
                            <p></p>
                        </div>
                    </div>
                    <div class="card-body p-3 pt-1 mb-3">
                        ...
                        <table class="table table-bordered bg-light">
                            <tr>
                                <th style="width: 30%">Jumlah Kutipan Yuran</th>
                                <td>RM {{$jumlah_kutipan}}</td>

                                <th style="width: 30%">Jumlah Pelajar</th>
                                <td>{{$jumlah_pelajar}}</td>
                            </tr>
                            <tr>
                                <th style="width: 30%">Jumlah Selesai Bayar</th>
                                <td>{{$selesai}}</td>
                                <th style="width: 30%">Jumlah Belum Bayar</th>
                                <td>{{$belum_selesai}}</td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>ID Transaksi</th>
                                    <th style="width: 30%">Nama Pelajar</th>
                                    <th style="width: 30%">Nama Ibu / Bapa / Penjaga</th>
