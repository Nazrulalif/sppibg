                ...
                <div class="card-body login-card-body">
                    ...
                    <div class="alert alert-info" style="font-size: 0.85rem;">
                        ...
                        <small>
                            ...
                            <strong>Setiausaha:</strong> setiausaha@example.com<br>
                            <strong>Bendahari:</strong> bendahari@example.com<br>
                            <strong>Naib Presiden:</strong> naibpresiden@example.com<br>
                            <strong>Ahli Jawatankuasa:</strong> jawatankuasa@example.com<br>
                            <strong>Ahli Biasa:</strong> ahlibiasa@example.com<br>
